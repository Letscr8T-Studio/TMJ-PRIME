...
export const siteConfig: SiteConfig = {
  ...
  accreditations: [],
  nav,
  headerCta: { label: "Get trade pricing", href: "/contact" },
  sectors,
  products,
  valueProps,
  hero: {
    ...
    highlights: [
      ...
      "Trade & partnership accounts",
      "Reliable UK delivery",
    ],
  },
  reseller: {
    eyebrow: "Trade & partnership accounts",
    headline: "Become a TMJprime partner",
    ...
    cta: { label: "Set up a partner account", href: "/contact" },
  },
  copy,
  contactForm,
  seo,
